...
class NoticeState extends State<Notice> {
  ...
  final String url = "https://terraforming.info/notice";
        ...
        child: RefreshIndicator(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                const Text("CosmosX 업데이트 공지, 제휴 문의"),
                ...
                Expanded(
                  child: ListView(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: _noticebuildCommentListNews(
...
class _noticebuildCommentListNews extends StatefulWidget {
  final Function(bool) updateVisibility;
  final List<CommentP> commentData;
  final String? itemIndex;

  const _noticebuildCommentListNews({
  ...
  @override
  State<_noticebuildCommentListNews> createState() => _noticebuildCommentListNewsState();
}

class _noticebuildCommentListNewsState extends State<_noticebuildCommentListNews> {
  final FocusNode _noticecommentFocusNode = FocusNode();
  final Map<int, FocusNode> _noticereplyFocusNodes = {};
  final TextEditingController _noticenewCommentController =
  TextEditingController(); // 새 댓글을 위한 컨트롤러
  final Map<int, TextEditingController> _noticereplyControllers = {};
  final Map<int, bool> _noticeshowReplyField = {};
  // final quill.QuillController _noticenewCommentController = quill.QuillController.basic();

  @override
  void initState() {
    super.initState();
    _noticecommentFocusNode.addListener(_handleFocusChange);
  }

  @override
  void dispose() {
    _noticecommentFocusNode.removeListener(_handleFocusChange);
    _noticecommentFocusNode.dispose();
    _noticereplyFocusNodes.forEach((key, focusNode) {
  ...
  void _handleFocusChange() {
    if (_noticecommentFocusNode.hasFocus ||
        _noticereplyFocusNodes.values.any((focusNode) => focusNode.hasFocus)) {
              ...
              child: Column(
                children: [
                  SizedBox(
                    width: ResponsiveWidth.getResponsiveWidth(context),
                    child: TextFormField(
                      focusNode: _noticecommentFocusNode,
                      controller: _noticenewCommentController,
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            dynamic text = _noticenewCommentController.text
                                .trim();
                            if (text.isNotEmpty) {
                              _sendComment(text);
                              _noticenewCommentController.clear();
                            } else {
  ...
  Widget buildComment(CommentP comment) {
    ...
    final deviceWidth = ResponsiveWidth.getResponsiveWidth(context);
    _noticereplyFocusNodes[comment.comment_id] ??= FocusNode()
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            !(_noticeshowReplyField[comment.comment_id] ??
                                false);
                            _noticeshowReplyField.clear();
                            _noticeshowReplyField[comment.comment_id] =
                                currentFieldState;
                          });
                        },
                ...
                if (_noticeshowReplyField[comment.comment_id] ?? false)
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          focusNode: _noticereplyFocusNodes[comment.comment_id],
                          controller: _noticereplyControllers[comment
                              .comment_id] ??=
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                String text =
                                    _noticereplyControllers[comment.comment_id]
                                        ?.text
                                        .trim() ??
                                        '';
