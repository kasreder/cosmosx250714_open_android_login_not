...
import 'comm_record_comment_list_screen.dart';
...
class RecordDetailsScreenState extends State<RecordDetailsScreen> {
  ...
  final String middleMunu = 'comm1/record';
  ...
  Future<void> extractMenuMapData2(String? itemIndex) async {
    ...
    try {
      ...
      final url = "https://api.cosmosx.co.kr/record/$itemIndex";
    ...
    return Scaffold(
      ...
      body: FutureBuilder<PostWithComments>(
          ...
          builder: (context, snapshot) {
            ...
            print('RecordData11: ${jsonEncode(RecordData.toJson())}');
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            SelectableText(RecordData.nickname ?? 'No nickname', style: const TextStyle(color: Colors.grey, fontSize: 15)),
                                            SelectableText(
                                              '조회 ${(RecordData.views ?? 0).toString()}',
                                              style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Colors.grey, fontSize: 15),
                                            ),
                                            Text(DateUtil.formatDate(RecordData.created_at), style: const TextStyle(color: Colors.grey, fontSize: 15)),
                                          ],
                                        ),
                                      ),
