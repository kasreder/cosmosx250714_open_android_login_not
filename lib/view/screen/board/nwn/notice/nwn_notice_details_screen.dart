...
import 'nwn_notice_comment_list_screen.dart';
...
class NoticeDetailsScreenState extends State<NoticeDetailsScreen> {
  ...
  final String middleMunu = 'nwn1/notice';
  ...
  String constructUrl() {
    ...
    return "https://api.cosmosx.co.kr/notice/$itemIndex";
  }
  ...
  Future<void> extractMenuMapData2(String? itemIndex) async {
    ...
    try {
      ...
      final url = "https://api.cosmosx.co.kr/notice/$itemIndex";
      ...
      body: FutureBuilder<PostWithComments>(
          ...
          builder: (context, snapshot) {
            ...
            final quillController = quill.QuillController(
              document: quill.Document.fromJson(jsonDecode(NoticeData!.content)),
              selection: const TextSelection.collapsed(offset: 0),
            );

            print('currentUserId : $currentUser');
            print('NoticeData11: ${jsonEncode(NoticeData.toJson())}');
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                const Padding(
                                                  padding: EdgeInsets.fromLTRB(8, 10, 8, 1),
                                                  child: Icon(
                                                    // Icons.add_chart,
                                            ...
                                            SelectableText(NoticeData.nickname ?? 'No nickname', style: const TextStyle(color: Colors.grey, fontSize: 15)),
                                            Text(DateUtil.formatDate(NoticeData.created_at), style: const TextStyle(color: Colors.grey, fontSize: 15)),
                                          ],
                                        ),
                                      ),
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Row(
                                              children: [
                                                if (isLoggedIn)
                                                  NoticeData.nickname == currentUser
                                                      ? Row(
                                                          children: [
                                                            TextButton(
                                                              onPressed: () {
